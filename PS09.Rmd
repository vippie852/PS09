...
1. After running KMC 10 times, I noticed that in 5 out of the 10 times, the blue cluster was predicted to have a `x1` value of lower than 1.0 and vice versa. This shows that there's equal chance that the clusters can be predicted to have a `x1` value above or below 1.0. 
...
3. After running KMC 10 times on `observations_2`, I noticed that the predictive consistency is much higher for these observations as compared with `observations_1`. 8 out of the 10 times showed that the red cluster has a `x1` value of less than 1.0 which indicates strong predictive accuracy.
